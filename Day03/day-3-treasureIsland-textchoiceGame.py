...
# conditional logic game based on user input.
# first question
...
if first_question == "left":
    ...
    # second question if user chooses the right answer for question 1.
    second_question = input(
        "There is an island in the middle of the lake. Type 'wait' for a boat. Type 'swim' to swim across.\n")
    if second_question == "wait":
        ...
        # third question if user chooses the right answer for question 2.
